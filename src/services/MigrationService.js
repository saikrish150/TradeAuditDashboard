...
export const migrationService = {
  ...
  mapTradeRow(row) {
    return {
      ...
      pl: this.cleanCurrency(row['P/L'] || row['P & L'] || row['Profit/Loss'] || row['Net P&L'] || row['Amount'] || row['Profit'] || row['pl']),
      ...
      reasonForTrade: row['Reason For Trade'] || row['Reson For Trade'] || row['TradeReason'] || row['Reason'] || '',
      ...
      rr: row['Taken RR'] || row['TAKEN RR'] || row['RR'] || '',
